...
#include "autotest/functionautotest.h"
...
//    FunctionTest* test = new FunctionTest("/dev/ttyUSB0");
//    test->startTest();
...
//    FunctionTest* test = new FunctionTest("/dev/ttyUSB0");//settings.value("functionTestPort").toString()
...
//    });
    ...
    FunctionAutoTest* ftTest = new FunctionAutoTest("/dev/ttyUSB0", 4);
    ftTest->startTest();
}
